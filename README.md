...
|------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software.             | **Casimiro Fernández, Carlos Oswaldo** <br> **TB1:** En el transcurso del proyecto se ha tenido que realizar una comunicación efectiva con los segmentos objetivo e interesados del proyecto, para obtener la mayor cantidad de requisitos y necesidades posibles, esto ayuda a construir un mejor diseño de proyecto ágil.<br> <br> <br> **TP:** El equipo se organizó para realizar las mejoras del proyecto y realizar el primer avance de la Web Application teniendo en cuenta las habilidades de cada integrante del equipo.<br> <br> <br> **TB2:** El equipo se organizó para avanzar diferentes partes del proyecto relacionados con el Backend y tuvo que hacer muchas coordinaciones previas.<br> <br> <br> **TF:** Para esta unidad se trabajó en el desarrollo del backend, el equipo logró trabajar y aportar con sus diversas cualidades de manera ágil.<br> <br> **Ramírez Mendoza, Carlos Arian** <br> **TB1:** En el transcurso del proyecto se ha tenido que realizar una comunicación efectiva con los segmentos objetivo e interesados del proyecto, para obtener la mayor cantidad de requisitos y necesidades posibles, esto ayuda a construir un mejor diseño de proyecto ágil. <br> <br> <br> **TP:** El equipo se organizó para realizar las mejoras del proyecto y realizar el avance de la Web Application teniendo en cuenta las habilidades de cada integrante del equipo. <br> <br> <br> **TB2:** El equipo se organizó para avanzar diferentes partes del proyecto relacionados con el Backend.<br> <br> <br> **TF:** Para esta unidad se trabajó en el desarrollo del backend, el equipo logró trabajar y aportar con sus diversas cualidades de manera ágil. <br> <br> **Rivas Sarango, David Alejandro** <br> **TB1:** <br> En esta entrega me encargué del rol de Software Manager, capacitando y comunicando de manera efectiva los pasos a seguir para comprender cada herramienta usada para el ciclo de vida de nuestra startup.<br> <br> **TP:**El equipo se organizó para realizar las mejoras del proyecto y realizar el avance de la Web Application teniendo en cuenta las habilidades de cada integrante del equipo. <br> Durante la entrega me encargué de guiar a los demas integrantes para que la entrega se cumpla al 100%.<br> <br> **TB2:** <br> En esta entrega me encarguúe de mantener los endpoints lo mas presentable y funcional posible, explicandole a cada integrante el funcionamiento correcto de los endpoints para una buena entrega.<br> <br> **TF:** <br> En la presente entrega realize de manera activa y comunicativa una busqueda de union por el equipo para la union de cada bounded context y las diferencias de codigo.<br> **Landeo Simeón, Favio Sebastián** <br> **TB1:** <br> En esta primera entrega me encargué de participar activamente en las reuniones grupales para acordar las bases del proyecto. <br> <br> **TP:** <br> En el trabajo parcial me comuniqué con mi equipo para subsanar según la retroalimentación del profesor. <br> <br> **TB2:** <br> En esta entrega me centré en actualizar el endpoint que me tocaba siempre con la comunicación activa con mis compañeros de grupo. <br> <br> **TF:** <br> En esta última entrega me encargué de comunicar los cambios que realizaba en mi endpoint para avanzar colaborativamente. <br> <br> **Valenzuela Vallejos, Alessandro Stefano** <br> **TB1:** <br> Durante la entrega, me encargué de guiar al equipo en la realización de las partes del trabajo de manera comunicativa, empática y centrada, para una mejor resolución del proyecto. <br> <br> **TP:** <br> En esta entrega, mi objetivo fue mejorar en todos los aspectos posibles respecto a entregas anteriores y fortalecer la comunicación con mis compañeros en todos los medios disponibles. Aunque aún existen obstáculos para lograr una comunicación perfecta, noté cierta mejoría en este aspecto. <br> <br> **TB2:** <br> Durante esta fase, nos enfrentamos a una carga abrumadora de actualizaciones y mejoras necesarias para obtener un producto final de calidad. A pesar de los desafíos, busqué alternativas para mejorar nuestro trabajo y participé activamente en la búsqueda de soluciones para evitar complicaciones adicionales.<br> <br> **TF:** <br> Para esta ultima entrega, me encargue de terminar de desarrollar mi parte final que se me fue asignada para el trabajo, esta enfocada en la conexion del backend con el front para tener un proyecto lo mas completo posible.| El equipo trabajó de manera cohesiva y eficiente, aprovechando las diversas habilidades de sus miembros para desarrollar una solución robusta y efectiva en el proyecto. | El equipo trabajó de manera cohesiva y eficiente, aprovechando las diversas habilidades de sus miembros para desarrollar una solución robusta y efectiva en el proyecto.                                                                                                                                   |
| Conoce al menos un sector empresarial o dominio de aplicación de soluciones de software.                                                                         | **Casimiro Fernández, Carlos Oswaldo** <br> **TB1:** Mantenimiento de comunicación efectiva con los interesados del proyecto.<br> <br> <br> **TP:** Organización del equipo para mejoras del proyecto y desarrollo de la Web Application<br> <br> <br> **TB2:** Enfoque en el avance de diferentes secciones del proyecto, especialmente en Backend. <br> <br> <br> **TF:** Encargo de funcionalidades demandadas por los usuarios, incluyendo desarrollo de mockups y base de datos<br> <br> **Ramírez Mendoza, Carlos Arian** <br> **TB1:** Durante las primeras etapas del proyecto se tuvo que fomentar una buena comunicación tanto entre los miembros del equipo como con los usuarios objetivo.<br> <br> <br> **TP:** El equipo tuvo que organizar diversas reuniones para de este modo se puedan aprovechar las habilidades de cada integrante, con el fin de desarrollar un producto competente y funcional.<br> <br> <br> **TB2:** Se tuvo que hacer muchas mejoras al Backend tras las nuevas Interviews, además de coordinar mejor nuestros esfuerzos como equipo.<br> <br> <br> **TF:** Tras muchos obstáculos y también aciertos, se pudo culminar la creación y desarrollo de la WebApp, pues todas las mejoras fueron implementadas, concretando finalmente la creación total de TrackMyRoute.<br> <br> **Rivas Sarango, David Alejandro** <br> **TB1:** <br> En esta primera entrega investigamos sobre las necesidades de las rutas optimas y falta de organizacion de transporte en nuestro pais para desarrollar una posible solucion.<br> <br> **TP:** <br> Para esta entrega realice una implementacion en frontend sobre las promociones que ofreceria nuestra aplicacion para el interes popular hacia esta.<br> <br> **TB2:** <br> Para esta entrega se realizo el backend sobre el bounded context de promos, el cual instiga al usuario a usar al menos una para su beneficio con el fin de desplazarse.<br> <br> **TF:** <br> En la ultima entrega integramos la logica del backend con el frontend para el producto completo funcional y asi presentarle a los usuarios finales para que puedan usarlo en el sector de transporte.<br> **Landeo Simeón, Favio Sebastián** <br> **TB1:** <br> En esta primera entrega investigué junto a mi grupo sobre las bases del proyecto que escogimos. <br> <br> **TP:** <br> Para esta entrega corregimos según la retroalimentación del profesor y con una investigación continua. <br> <br> **TB2:** <br> Desarrollé características de la aplicación que abordan lógica del proyecto correctamente a partir de la investigación del sector. <br> <br> **TF:** <br> Trabajé en desarrollar la última parte de la lógica en mi endpoint según la lógica que seguimos del sector. <br> <br> **Valenzuela Vallejos, Alessandro Stefano** <br> **TB1:** <br> Investigué las mejores prácticas del sector de transporte para optimizar las rutas en la aplicación. <br> <br> **TP:** <br> Implementé los conocimientos adquiridos para mejorar la eficiencia de la aplicación y adaptarla a las necesidades que tenemos. <br> <br> **TB2:** <br> Realicé pruebas exhaustivas para asegurar que la aplicación cumpliera con los estándares del sector y ofreciera un servicio fiable y eficiente.  <br> <br>**TF:** <br> Termine con los ultimos detalles para el desarrollo de nuestro proyecto, corregimos y mejoramos para que sea una pagina mas amigable para el usuario.  | El equipo adquirió un conocimiento profundo del sector del transporte, aplicando este entendimiento para crear una aplicación de rutas eficiente y adaptada a las necesidades del usuario.                                                                                                   |
